...
set "SCRIPT="
for %%P in ("%~dp0gerencial_por_vendedor_html.js" "%~dp0\gerencial_por_vendedor_html.js" "%userprofile%\desktop\gerencial_por_vendedor_html.js" "%userprofile%\documents\gerencial_por_vendedor_html.js" "%userprofile%\downloads\gerencial_por_vendedor_html.js") do if not defined SCRIPT if exist "%%~fP" set "SCRIPT=%%~fP"
